...
const translations = {
  pt: {
    ...
    tipsNote: "As dicas são geradas automaticamente com base nas tuas transações e objetivos. Quanto mais dados registares, mais precisas serão as recomendações.",
    ...
    // AI Responses
    aiResponseSaving: "Com uma taxa de poupança atual de {rate}%, poderias otimizar cortando em gastos não essenciais. O teu objetivo principal é \"{objective}\".",
    aiResponseSpending: "Este mês já gastaste {currency}{expenses}. Em comparação com os teus ganhos ({currency}{income}), o teu saldo livre é de {currency}{balance}.",
    aiResponseInvesting: "Tendo um património de {currency}{patrimony}, começar a investir parte do teu capital em ETFs ou contas-poupança de alto rendimento pode ajudar a bater a inflação.",
    aiResponseInvestingStart: "Para começar a investir, o ideal é construir primeiro um fundo de emergência. Tenta poupar cerca de 3 a 6 meses das tuas despesas habituais.",
    aiResponseDebt: "A melhor estratégia para reduzir dívidas é pagar primeiro a que tem a taxa de juro mais alta (método Avalanche).",
    aiResponseDefault1: "Essa é uma excelente perspetiva. Com um saldo limpo de {currency}{balance} este mês, estás no caminho certo.",
    aiResponseDefault2: "Posso ajudar com dicas de poupança, análise do teu orçamento ou estratégias de planeamento a longo prazo.",
    aiResponseDefault3: "Podes sempre aplicar a regra 50/30/20 ao teu orçamento: 50% necessidades, 30% desejos e 20% para a tua poupança futura!",
    aiResponseDefault4: "A chave do sucesso financeiro é a consistência no registo de cada transação!",

    // Dynamic Tips
    tipSavingsTarget: "{name} tenta poupar pelo menos 20% do teu rendimento mensalmente.",
    ...
    tipEntertainmentLimit: "Os gastos com lazer estão elevados. Considera definir um limite mensal.",
    tipSavingsSuccess: "Excelente! Estás a poupar mais de 30% do teu rendimento.",
    tipLongHorizon: "Com um horizonte de investimento longo, os teus excedentes mensais podem crescer significativamente.",
    tipNoData1: "Regista as tuas receitas e despesas regularmente para receberes dicas personalizadas.",
    tipNoData2: "Define um orçamento mensal para cada categoria.",
  },

  en: {
    // Carousel Intro
    introSlide1Title: "Your Money, Smarter",
    introSlide1Desc: "Savvy manages your spending automatically. Intelligence that works for you.",
    ...
    introSlide3Desc: "Everything you own consolidated in one place. Strategic and total control.",
    introSlide4Title: "Strategic Insights",
    introSlide4Desc: "Charts that explain your behavior, not just cold numbers.",
    introSlide5Title: "Freedom Achieved",
    introSlide5Desc: "Where your goals become reality. Your future starts here.",
    skip: "Skip",
    next: "Next",
    startNow: "Start Now",
    // Tabs
    ...
    yourTipsName: "Your tips", tipsNote: "Tips are automatically generated based on your transactions and goals.",
    // Transactions
    ...
    deleteAccountTitle: "Delete Account", deleteAccountMsg: "Are you sure? This action is irreversible.", deleteAccountConfirm: "Delete permanently",
    ...
    // Forgot Password
    forgotPassword: "Forgot your password?", forgotPasswordTitle: "Reset password", forgotPasswordDesc: "Enter your account email.",
    forgotPasswordSend: "Send link", forgotPasswordSuccess: "Email sent!", forgotPasswordSuccessMsg: "Check your inbox.",
    ...
    onbObjectiveSub: "We'll customize your tips and recommendations.", onbIncome: "What is your approximate monthly income?", onbIncomeSub: "In euros.",
    onbPatrimony: "What is your current net worth?", onbPatrimonySub: "Savings, investments and other assets.",
    onbDebts: "Do you have debts?", onbDebtsSub: "0 if you have none.",
    onbDependents: "Do you have financial dependents?", onbDependentsSub: "Children, spouse, etc.",
    onbHorizon: "What is your investment horizon?", onbHorizonSub: "How long?",
    onbYes: "Yes", onbNo: "No", onbContinue: "Continue", onbStart: "Get Started",
    // Common
    ofLabel: "of", oopsTitle: "Oops!",
    // AI Responses
    aiResponseSaving: "With a current savings rate of {rate}%, you could optimize by cutting non-essential spending.",
    aiResponseSpending: "This month you've already spent {currency}{expenses}.",
    aiResponseInvesting: "With assets of {currency}{patrimony}, starting to invest can help.",
    aiResponseInvestingStart: "To start investing, ideally build an emergency fund first.",
    aiResponseDebt: "The best strategy to reduce debt is the Avalanche method.",
    aiResponseDefault1: "That's an excellent perspective.",
    aiResponseDefault2: "I can help with savings tips or budget analysis.",
    aiResponseDefault3: "Try the 50/30/20 rule!",
    aiResponseDefault4: "The key to financial success is consistency!",
    // Tips
    tipSavingsTarget: "{name} try to save at least 20% of your income monthly.",
    tipHighExpenses: "Your spending is above 80%.",
    tipTopCategory: "Your highest spending category is {category}.",
    tipDebtPriority: "Prioritize paying off debts with the highest interest rates first.",
    tipEntertainmentLimit: "Entertainment spending is high.",
    tipSavingsSuccess: "Excellent! You are saving more than 30%.",
    tipLongHorizon: "With a long investment horizon, your monthly surpluses can grow.",
    tipNoData1: "Record your income and expenses regularly.",
    tipNoData2: "Set a monthly budget.",
  },
  ...
  es: {
    ...
    // Tabs
    tabHome: "Inicio", tabAnalysis: "Análise", tabTransactions: "Transações", tabTips: "Dicas", tabAI: "IA", tabSettings: "Definições",
    // AI Chat
    ...
    // Analytics
    analysisTitle: "Análise", byMonth: "Por Mes", byCategory: "Por Categoría", last6months: "Últimos 6 meses", bestMonth: "Mejor Mes", worstMonth: "Peor Mes", topCategories: "Mayor gasto por categoria",
    ...
    // Tips
    tipsTitle: "Dicas", tipsSubtitle: "Personalizados para ti", tipsSubtitleName: "Recomendaciones", mainObjectiveLabel: "Objetivo principal",
    ...
    // Transactions
    transactionsTitle: "Transações", all: "Todas", noTransactionsList: "Sin transacciones", noTransactionsListHint: 'Regístralos tocando el "+"',
    ...
    // Settings
    settingsTitle: "Definições", sectionProfile: "PERFIL", nameLabel: "Nombre", monthlyIncomeLabel: "Ingreso Mensual", initialPatrimonyLabel: "Patrimonio Inicial",
    ...
    // Account
    sectionAccount: "CONTA", accountEmail: "Email", accountEmailDesc: "Cambiar correo electrónico", accountPassword: "Contraseña", accountPasswordDesc: "Cambiar contraseña",
    ...
    // Forgot Password
    forgotPassword: "¿Olvidó su contraseña?", forgotPasswordTitle: "Recuperar contraseña", forgotPasswordDesc: "Introduce tu email.", forgotPasswordSend: "Enviar enlace", forgotPasswordSuccess: "¡Enviado!", forgotPasswordSuccessMsg: "Revisa tu bandeja de entrada.", forgotPasswordError: "Error.", forgotPasswordEmailPlaceholder: "Tu email",
    resetPasswordTitle: "Restablecer contraseña", resetPasswordSuccess: "¡Contraseña actualizada!", resetPasswordError: "Error.", updatePasswordBtn: "Actualizar contraseña",
    langPt: "Português", langEs: "Español", langFr: "Francês", langEn: "Inglês",
    // Objectives
    ...
    // Horizons
    horizonShort: "Corto plazo (< 1 año)", horizonMedium: "Medio plazo (1-5 años)", horizonLong: "Largo plazo (5+ anos)",
    // Category labels
    ...
    catHealth: "Salud", catEntertainment: "Ocio", catShopping: "Compras", catEducation: "Educación", catUtilities: "Servicios", catTravel: "Viaje", catOther: "Outro",
    // Onboarding
    ...
    // AI Responses
    aiResponseSaving: "Con una tasa de ahorro del {rate}%, podrías reducir gastos no esenciales.",
    aiResponseSpending: "Este mes has gastado {currency}{expenses}.",
    aiResponseInvesting: "Con un patrimonio de {currency}{patrimony}, invertir en ETFs puede ayudar.",
    aiResponseInvestingStart: "Para invertir, construye primero un fondo de emergencia.",
    aiResponseDebt: "La mejor estrategia es pagar primero la deuda con el interés más alto.",
    aiResponseDefault1: "Excelente perspectiva.",
    aiResponseDefault2: "Puedo ayudarte con consejos.",
    aiResponseDefault3: "Aplica la regla 50/30/20.",
    aiResponseDefault4: "La clave es la consistencia.",
    // Tips
    tipSavingsTarget: "{name} intenta ahorrar al menos el 20% de tus ingresos.",
    tipHighExpenses: "Tus gastos superan el 80%.",
    tipTopCategory: "Tu mayor gasto es {category}.",
    tipDebtPriority: "Prioriza deudas con intereses más altos.",
    tipEntertainmentLimit: "Los gastos en ocio son elevados.",
    tipSavingsSuccess: "¡Excelente! Ahorras más del 30%.",
    tipLongHorizon: "Con un horizonte largo, tus excedentes pueden crecer mucho.",
    tipNoData1: "Registra ingresos y gastos.",
    tipNoData2: "Define un presupuesto.",
  },
  ...
  fr: {
    ...
    aiWelcome: "Salut! Je suis votre assistant financier.",
    ...
    noTransactions: "Aucune transaction", noTransactionsHint: 'Appuyez sur "+"', currentPatrimony: "Patrimoine Actuel", budgetUsed: "Budget utilisé",
    // Add/Edit Transaction
    ...
    passwordMismatch: "Les mots de passe ne correspondent pas.", passwordTooShort: "Minimum 6 caracteres.", accountUpdated: "Mis à jour!", accountUpdateError: "Erreur.",
    deleteAccountTitle: "Supprimer le compte", deleteAccountMsg: "Êtes-vous sûr?", deleteAccountConfirm: "Supprimer",
    ...
    // Forgot Password
    forgotPassword: "Mot de passe oublié?", forgotPasswordTitle: "Réinitialiser", forgotPasswordDesc: "Entrez votre email.", forgotPasswordSend: "Envoyer", forgotPasswordSuccess: "Envoyé!", forgotPasswordSuccessMsg: "Vérifiez votre boîte de réception.", forgotPasswordError: "Erreur.", forgotPasswordEmailPlaceholder: "Votre email",
    resetPasswordTitle: "Réinitialiser le mot de passe", resetPasswordSuccess: "Mot de passe mis à jour!", resetPasswordError: "Erreur.", updatePasswordBtn: "Mettre à jour",
    langPt: "Portugais", langEs: "Espagnol", langFr: "Français", langEn: "Anglais",
    // Objectives
    objSave: "Économiser", objDebt: "Réduire les dettes", objInvest: "Investir", objControl: "Contrôler les dépenses", objFreedom: "Independance financière",
    ...
    // Onboarding
    onbName: "Bonjour! Quel est votre nom?", onbNameSub: "Personnalisons votre experiência.", onbNamePlaceholder: "Votre nom", onbObjective: "Quel est votre objectif?",
    ...
    ofLabel: "de", oopsTitle: "Oops!",
    // AI Responses
    aiResponseSaving: "Avec un taux d'épargne de {rate}%, vous pourriez optimiser.",
    aiResponseSpending: "Ce mois-ci vous avez dépensé {currency}{expenses}.",
    aiResponseInvesting: "Avec un patrimoine de {currency}{patrimony}, investir pode ajudar.",
    aiResponseInvestingStart: "Construisez un fonds d'urgence.",
    aiResponseDebt: "La meilleure stratégie est de payer d'abord la dette au taux le plus élevé.",
    aiResponseDefault1: "Excellente perspective.",
    aiResponseDefault2: "Je peux vous aider.",
    aiResponseDefault3: "Appliquez la règle 50/30/20.",
    aiResponseDefault4: "La clé est la régularité.",
    // Tips
    tipSavingsTarget: "{name} essayez d'épargner au menos 20%.",
    tipHighExpenses: "Vos dépenses sont supérieures à 80%.",
    tipTopCategory: "Votre catégorie la plus élevée est {category}.",
    tipDebtPriority: "Priorisez le remboursement.",
    tipEntertainmentLimit: "Les dépenses de loisirs sont élevées.",
    tipSavingsSuccess: "Excellent! Vous épargnez plus de 30%.",
    tipLongHorizon: "Avec un horizon long, vos surplus peuvent croître.",
    tipNoData1: "Enregistrez vos revenus.",
    tipNoData2: "Fixez un budget.",
  },
};
