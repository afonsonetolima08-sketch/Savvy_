...
const translations = {
  pt: {
    // Carousel Intro
    introSlide1Title: "Inteligência Financeira",
    introSlide1Desc: "Gestão automática e simples do teu dinheiro.",
    introSlide2Title: "Assistente IA",
    introSlide2Desc: "Dicas personalizadas para poupares mais.",
    introSlide3Title: "Património Global",
    introSlide3Desc: "Controlo total de investimentos e ativos.",
    introSlide4Title: "Análises Reais",
    introSlide4Desc: "Gráficos avançados sobre os teus hábitos.",
    introSlide5Title: "Sincronização Cloud",
    introSlide5Desc: "Dados seguros e sempre acessíveis.",
    skip: "Saltar",
    next: "Seguinte",
  ...
  en: {
    // Carousel Intro
    introSlide1Title: "Financial Intelligence",
    introSlide1Desc: "Simple and automatic management of your money.",
    introSlide2Title: "AI Assistant",
    introSlide2Desc: "Personalized tips to help you save more.",
    introSlide3Title: "Global Assets",
    introSlide3Desc: "Complete control of investments and assets.",
    introSlide4Title: "Real Analytics",
    introSlide4Desc: "Advanced charts about your habits.",
    introSlide5Title: "Cloud Sync",
    introSlide5Desc: "Secure data, always accessible.",
    skip: "Skip",
    next: "Next",
    startNow: "Start Now",
    // Tabs
