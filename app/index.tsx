        ...
        <View style={styles.benefitsSection}>
           ...
           <View style={styles.benefitsGrid}>
              {[
                { 
                  title: "IA Preditiva", 
                  desc: "Antecipa tendências de mercado e padrões de gastos antes de acontecerem.",
                  icon: "activity",
                  delay: 200
                },
                { 
           ...
           <View style={styles.spotlightContent}>
              <View style={styles.aiVisual}>
                 ...
                 <BlurView intensity={20} tint="light" style={styles.aiBubble}>
                    ...
                    <Text style={styles.aiBubbleText}>
                       "Detetei uma oportunidade de otimização fiscal de **240€** nos teus investimentos recentes. Queres automatizar a declaração?"
                    </Text>
                 </BlurView>
              </View>
              ...
              <View style={styles.aiTextContainer}>
                 ...
                 <Text style={styles.aiHighlightDesc}>
                    Não somos apenas um tracker. Somos um agente ativo que trabalha 24/7 para encontrar capital onde antes havia apenas confusão.
                 </Text>
              </View>
           </View>
        </View>
